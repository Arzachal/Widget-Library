function vlWidgetHandler(widgetId, settings = { arrows: {}, dots: {} }) {
    ...
    function styleGenerator() {
        var styleString =
            ...
            "#" + widgetId + ">.vl-slider{scroll-behavior: smooth; position: relative; " + dimension1 + ": " + ((itemSize * itemsViewed) + (itemsViewed == 1 ? 20 : 0)) + "px; " + dimension2 + ":" + (itemSize2 + (dots ? 50 : 15)) + "px; margin: 0 auto; l-webkit-overflow-scrolling: touch;scroll-snap-type:"+ (axis=="X"? "x" : "y")+" mandatory;-ms-scroll-snap-type: mandatory;scroll-snap-points-x: repeat(100%);-ms-scroll-snap-points-x: repeat(100%);overflow: hidden; }" +
            ...
            "#" + widgetId + ">.vl-slider>.vl-slider-wrapper>.vl-slider-item{overflow:hidden;" + dimension1 + ":" + itemSize + "px; " + dimension2 + ":" + itemSize2 + "px; display:inline-block; float:left; scroll-snap-align: center center;}";
        if (arrows) {
            var arrowStyle;
